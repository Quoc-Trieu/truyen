      ...
      <div className={styles.itemContainer}>
        <div className={styles.itemUI}>
          ...
          <div className={styles.actionItem} style={{ pointerEvents: permissionEditUser ? 'auto' : 'none' }}>
            ...
            <img src={iconRemove} className={styles.remove} onClick={() => onRemove()} />
            ...
            <Dropdown style={{ height: '100%' }} drop="down">
              ...
              <Dropdown.Menu style={{ padding: 0 }}>
                <Dropdown.Item
                  ...
                  style={{ background: '#6fb900' }}
                >
                  <span className={styles.textDropLock}>Mở khoá</span>
                  <img className={styles.iconDropLock} src={iconUnLock} />
                </Dropdown.Item>
              </Dropdown.Menu>
            </Dropdown>
          </div>
