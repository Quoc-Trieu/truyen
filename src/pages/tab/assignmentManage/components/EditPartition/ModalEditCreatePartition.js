...
const ModalEditCreatePartition = ({ visible, onCancel, onOk, data, subDivision }) => {
  ...
  return (
    ...
    >
        ...
        <FooterAssignment subDivision={subDivision} data={data} onCancel={() => {onCancel(); dispatch(resetSpacing([]))}}/>
    </ModalComponent>
  );
};
