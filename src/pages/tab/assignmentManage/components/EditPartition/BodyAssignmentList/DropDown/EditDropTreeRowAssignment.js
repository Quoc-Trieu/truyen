...
const EditDropTreeRowAssignment = ({ keyValue, label, styleCustom, NumRowOfLand, onSelectRow }) => {
  ...
  return (
    <div className={styles.dropDownComponent} style={{ background: "#fff", padding: "0px 10px", ...styleCustom }}>
