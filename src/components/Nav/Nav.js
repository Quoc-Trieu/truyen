    ...
    <div className={styles.navStyle} width={isOpenNav ? "250px" : "100px"}>
      <ul className={styles.ulNav}>
        <li
          ...
          style={{ marginBottom: !isOpenNav ? "50px" : "0px" }}
        >
          <img src={logo} />
        </li>
        ...
        {permisson !== "USER" ? (
          <>
            ...
            <li
              ...
              className={
                pathname === "/divisions" || pathname === "/assignment"
                  ? styles.li_Selected
                  : ""
              }
            >
        ...
        <li
          onClick={() => onChangeNav("attendanceCheck")}
          className={pathname === "/attendanceCheck" ? styles.li_Selected : ""}
        >
          <img src={iconPlantTree} />
        ...
        <li
          onClick={() => onChangeNav("tinhLuong")}
          className={pathname === "/tinhLuong" ? styles.li_Selected : ""}
        >
          <img src={iconPlantTree} />
        ...
        <li
          ...
          className={
            pathname === "/statisticsProduction" ? styles.li_Selected : ""
          }
        >
